...
let mapOuroborosError (OuroborosError err) = DogError.Validation err

let createDomainCommand' = Command.createDomainCommand mapOuroborosError

let createDeleteCommand' = Command.createDeleteCommand mapOuroborosError
